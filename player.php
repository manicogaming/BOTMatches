    ...
    if($result->num_rows > 0) {
        ...
        <div class="container-fluid card-body">
            ...
            <div class="row">
                ...
                echo '</ul></div><div class="col-lg-12 text-center" style="margin-top:10px;"><a class="btn btn-light py-2 px-4" href="http://localhost/rankme/profile.php?steamID='.$row['name'].'" target="_blank" rel="noopener nofollow">More Stats</a></div></div></div></div>'; 
